...
def mat(data):
    ...
    axs[0].grid()
    axs[1].set(title="Modified bubble sort",
               ylabel='Operations', xlabel='Array size')
    axs[1].grid()
    axs[2].set(title="Insertion sort",
               ylabel='Operations', xlabel='Array size')
    axs[2].grid()
    ...
    axs[0].plot(x_cords, y_cords, color="purple",
    ...
    for type in types:
        ...
        i += 1
    axs[1].plot(x_cords, y_cords, color="purple",
                linestyle='--', label="O(n^2)")
    axs[1].plot(x_cords, y_cords2, color="yellow",
                linestyle='--', label="O(n)")
    ...
    for type in types:
        ...
        i += 1
    axs[2].plot(x_cords, y_cords, color="purple",
                linestyle='--', label="O(n^2)")
    axs[2].plot(x_cords, y_cords2, color="yellow",
                linestyle='--', label="O(n)")
